...
var filePath = @"C:\Users\ihsan\Desktop\BOOK\web\src\lib\marketing-data.ts";
var c = File.ReadAllText(filePath, Encoding.UTF8);
...
// 4. Section 1 answer
c = c.Replace(
    "Evet, gerçek - ama çoğu zaman yanlış kaynaktan geliyor. İnsanlar 'iyi bir yazar olmam lazım' diye düşünür; bu düşünce başlamalarını engelleyen en büyük mentol bloğa dönüşür. Oysa bilgi kitabı yazarlığı edebi bir roman yazmaktan tamamen farklıdır. Bir romanda üslup, dil zenginliği ve kurgusal yaratıcılık merkezde yer alır. Rehber kitapta ise okur senden güzel cümleler değil, net bilgi ve pratik yönlendirme bekler. Zaten bildiğin bir konuda birikimini aktarıyorsun - bu bir arkadaşına bir şeyi anlatmaktan pek farklı değil. Bir koç, danışman ya da deneyimli bir uygulayıcı olarak zaten sahip olduğun bilgiyi kağıda dökmek yazarlık değil, aktarım becerisidir. Farklılık sadece yapıda: kitap, konuşmayı belirli bir sıraya sokar ve okura adım adım ilerler. Bu yapıyı kurmak için de çok güçlü bir yazar olmak gerekmez.",
    "Yes, it is real \u2014 but most of the time it comes from the wrong source. People think 'I need to be a good writer'; this thought becomes the biggest mental block preventing them from starting. But informational book authorship is completely different from writing a literary novel. In a novel, style, language richness, and fictional creativity take center stage. In a guide book, the reader expects not beautiful sentences but clear information and practical direction. You're already transferring knowledge on a topic you know \u2014 this is not much different from explaining something to a friend. As a coach, consultant, or experienced practitioner, putting your accumulated knowledge on paper is not authorship but transfer skill. The only difference is structure: the book organizes the explanation in a certain sequence and takes the reader through it step by step. You don't need to be a very strong writer to build this structure."
);
