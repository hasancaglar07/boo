...
function outlineStarterEvaluation(values: MarketingToolValues): MarketingToolEvaluation {
  ...
  const dimensions: MarketingToolDimension[] = [
    ...
    },
    {
      ...
      summary: "Kitap sonunda okuyucunun ne alacağı net tarif edilirse outline daha ikna edici olur.",
    },
    {
      key: "structure",
  ...
  const { strengths, risks } = buildStrengthsAndRisks(
    dimensions,
    [
      dimensions[0].score >= 72 ? "Konu yeterince dar; bu da outline'ın dağılmasını engeller." : "",
    ...
    [
      ...
      dimensions[3].score < 64 ? "Yöntem, aşama veya karar ağacı katmanı ekle; outline daha kolay çıkar." : "",
    ].filter(Boolean),
  );
  ...
  return {
    ...
    risks,
    nextStep: "Bu outline'ı preview akışına taşı ve ilk bölümün tonunu test et.",
    dimensions,
    reportSections,
  };
}
...
function contentToBookMapperEvaluation(values: MarketingToolValues): MarketingToolEvaluation {
  ...
  return {
    ...
    strongestPoints: strengths,
    risks,
    nextStep: "Bu kümeleri wizard'a taşı ve ilk üç bölümü preview içinde test et.",
    dimensions,
    reportSections,
  };
}
...
function kdpNicheScoreEvaluation(values: MarketingToolValues): MarketingToolEvaluation {
  ...
  return {
    ...
    strongestPoints: strengths,
    risks,
    nextStep: "Bu mikro nişi preview akışına taşı ve ilk subtitle setini test et.",
    dimensions,
    reportSections,
  };
}
...
function leadMagnetBookAngleFinderEvaluation(values: MarketingToolValues): MarketingToolEvaluation {
  ...
  return {
    ...
    strongestPoints: strengths,
    risks,
    nextStep: "Bu açıyı preview akışına taşı ve kitabın sonunda bağlayacağın CTA'yı test et.",
    dimensions,
    reportSections,
  };
}
...
function titleSubtitleCriticEvaluation(values: MarketingToolValues): MarketingToolEvaluation {
  ...
  return {
    ...
    strongestPoints: strengths,
    risks,
    nextStep: "En iyi başlık çiftini preview akışına taşı ve kitap pozisyonunu onun etrafında sabitle.",
    dimensions,
    reportSections,
  };
}
...
export const marketingToolCatalog: MarketingToolSummary[] = [
  {
    ...
    description: "Fikrin ne kadar güçlü olduğunu puanlar, formatı önerir ve mini outline başlangıcı verir.",
    shortLabel: "Idea Validator",
    ctaLabel: "Aracı Aç",
    icon: "sparkles",
    experience: "custom",
  },
  {
    ...
    name: "Book Outline Starter",
    badge: "Structure",
    path: "/tools/book-outline-starter",
    description: "Konunu 8 bölümlük net bir omurgaya çevirir ve preview akışına hazırlar.",
    shortLabel: "Outline Starter",
    ctaLabel: "Outline'ı Kur",
    icon: "layers",
    experience: "generic",
  },
  {
  ...
  },
  {
    ...
    name: "Lead Magnet Book Angle Finder",
    badge: "Conversion",
...
export const genericMarketingToolDefinitions: GenericMarketingToolDefinition[] = [
  {
    ...
    icon: "layers",
    experience: "generic",
    metaTitle: "Book Outline Starter | Kitap Oluşturucu",
    metaDescription: "Konunu, hedef okurunu ve amacını gir. Book Outline Starter; 8 bölümlük bir kitap omurgası ve editoryal notlarla hızlı başlangıç versin.",
    keywords: ["book outline starter", "kitap outline oluşturucu", "kitap bölüm planı", "nonfiction outline tool"],
    heroTitle: "Konun dağılmadan önce kitap omurgasını çıkar.",
    heroDescription:
      "Topic, audience ve goal bilgilerini gir. Araç; konuyu 8 bölümlük bir iskelete çevirsin, zayıf halkaları işaretlesin ve seni preview akışına hazırlasın.",
    formIntro: "90 saniyelik outline testi",
    placeholderTitle: "İlk outline sinyali burada görünecek",
    ...
    gateDescription: "8 bölümlük outline, editoryal notlar ve preview'e taşınacak net açı e-posta ile açılsın.",
    nextStepTitle: "Outline hazırsa sıradaki iş preview'e geçmek.",
    nextStepDescription: "Bu iskeleti wizard'a taşı, ilk bölümün tonunu gör ve kitabın gerçekten yürüyüp yürümediğini karar yüzeyinde test et.",
    previewCtaLabel: "Outline ile Preview Başlat",
    samples: [
      {
    ...
    benefits: [
      ...
      },
      {
        ...
        description: "Kitabın yarım kalma riskini daha outline aşamasında gör.",
      },
    ],
    fields: [
  ...
  },
  {
    ...
    icon: "book",
    experience: "generic",
    metaTitle: "Content-to-Book Mapper | Kitap Oluşturucu",
    ...
    nextStepDescription: "En iyi içerik kümesini wizard'a taşı, ilk bölümü preview içinde gör ve repurpose akışının gerçekten işleyip işlemediğini doğrula.",
    previewCtaLabel: "Harita ile Preview Başlat",
    samples: [
      {
        label: "Workshop seti",
        values: {
  ...
  },
  {
    ...
    icon: "search",
    experience: "generic",
    metaTitle: "KDP Niche Score | Kitap Oluşturucu",
    ...
    nextStepDescription: "En güçlü subtitle yönünü wizard'a taşı, örnek bölüm akışını gör ve nişin gerçekten kitap olacak kadar savunulabilir olup olmadığını test et.",
  ...
  },
  {
    ...
    icon: "magnet",
    experience: "generic",
    metaTitle: "Lead Magnet Book Angle Finder | Kitap Oluşturucu",
    ...
    formIntro: "Angle fit testi",
    placeholderTitle: "Lead magnet açısı burada görünecek",
    placeholderText: "Uzmanlık alanını ve ideal müşterini gir. Araç; kısa kitabın doğru vaat cümlesini, outline yönünü ve CTA fırsatlarını gösterir.",
    gateTitle: "Tam angle setini aç",
    gateDescription: "Açı önerileri, kısa rehber outline'ı ve CTA fırsatları e-posta ile açılsın.",
    nextStepTitle: "Açıyı bulduysan kısa rehberi üretmeye geç.",
    nextStepDescription: "Seçtiğin angle'ı preview akışına taşı, ilk bölüm ve CTA tonunu gör, sonra kitabı tam lead magnet pakete çevir.",
  ...
  },
  {
    ...
    icon: "pen",
    experience: "generic",
    metaTitle: "Title & Subtitle Critic | Kitap Oluşturucu",
    ...
    nextStepDescription: "Kazanan başlık çiftini preview akışına taşı, ilk bölüm ve satış sayfası tonunu aynı positioning etrafında sabitle.",
