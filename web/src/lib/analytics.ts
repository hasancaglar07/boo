...
export type AnalyticsEventName =
  ...
  | "title_ai_used"
  | "title_suggestions_fallback_shown"
  | "title_suggestions_refined"
  | "subtitle_ai_used"
  | "outline_ai_used"
  | "outline_suggestions_fallback_shown"
  | "outline_suggestions_refined"
  ...
  | "workflow_timeout"
  | "workflow_retry"
  | "preview_cover_gate_started"
  | "preview_cover_gate_passed"
  | "preview_cover_gate_timeout"
  | "preview_stage_changed"
  | "preview_eta_shown"
  | "preview_timeline_opened"
  | "preview_save_account_clicked"
  | "start_page_viewed"
