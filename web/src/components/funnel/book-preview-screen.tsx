          ...
          <div className="mx-auto flex max-w-lg items-center gap-3">
            <div className="min-w-0 flex-1">
              <p className="text-sm font-bold text-foreground">
                {formatUsd(commerce?.primaryOffer.priceCents || 400)} to unlock the full book
              </p>
              <p className="text-xs text-muted-foreground">
                PDF · EPUB · All chapters · 30-day refund
              </p>
            </div>
            <Button
              size="default"
...
[Output exceeded 50000 byte limit (66836 bytes total). Full output saved to C:\Users\ihsan\AppData\Local\Temp\.tmpP8JyT2\stdout-7. Read it with shell commands like `head`, `tail`, or `sed -n '100,200p'` up to 2000 lines at a time.]