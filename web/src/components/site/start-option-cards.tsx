...
const OPTIONS = [
  {
    ...
    href: "/start/topic",
    icon: Sparkles,
    label: "İlk kitabını başlat",
    description: "Konunu gir, wizard seni adım adım yönlendirsin. 10 dakikada outline + kapak önizlemesi.",
    cta: "Hemen Başla",
    highlight: true,
  },
  {
    ...
    description: "Gerçek kullanıcıların oluşturduğu kitaplara bak. Kaliteyi kendin değerlendir.",
    cta: "Örneklere Bak",
    highlight: false,
  },
  {
